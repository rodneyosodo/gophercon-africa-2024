...
require (
	...
	google.golang.org/grpc/stats/opentelemetry v0.0.0-20241017163036-56df169480cd
...
require (
	...
	github.com/grafana/loki/pkg/push v0.0.0-20241017144940-311797442f0a // indirect
